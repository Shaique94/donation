...
<head>
    ...
    <style>
        body,
        html {
            /* Use Inter with a sensible system fallback stack for broad compatibility */
...
<body class="bg-gray-100">
    ...
    <!-- Sidebar -->
    <aside id="sidebar"
        class="fixed top-0 left-0 z-50 w-64 h-screen pt-5 bg-[#fcf4e1] border-r border-gray-200 lg:translate-x-0 -translate-x-full transition-transform duration-300 ease-in-out">
            ...
            <ul class="space-y-2 font-medium">
                ...
                <li>
                    <a href="{{ route('admin.expenses') }}"
                        ...
                        <svg class="w-5 h-5 text-gray-500 transition duration-75 group-hover:text-gray-900"
                            ...
                            <path
                                d="M13 3C11.8954 3 11 3.89543 11 5V7C11 8.10457 11.8954 9 13 9H15C16.1046 9 17 8.10457 17 7V5C17 3.89543 16.1046 3 15 3H13Z" />
                            <path
                                d="M13 11C11.8954 11 11 11.8954 11 13V15C11 16.1046 11.8954 17 13 17H15C16.1046 17 17 16.1046 17 15V13C17 11.8954 16.1046 11 15 11H13Z" />
                        </svg>
                ...
                <li>
                    <a href="{{ route('admin.reports') }}"
                        ...
                        <svg class="w-5 h-5 text-gray-500 transition duration-75 group-hover:text-gray-900"
                            fill="currentColor" viewBox="0 0 20 20">
                            <path
                                d="M5 4C5 3.44772 5.44772 3 6 3H14C14.5523 3 15 3.44772 15 4V16C15 16.5523 14.5523 17 14 17H6C5.44772 17 5 16.5523 5 16V4Z" />
                ...
                <li>
                    <form method="POST" action="{{ route('logout') }}">
                        @csrf
                        <button type="submit"
                            class="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 w-full text-left">
                            <svg class="w-5 h-5 text-gray-500 transition duration-75 group-hover:text-gray-900"
                                fill="currentColor" viewBox="0 0 20 20">
